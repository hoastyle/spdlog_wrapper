...
void print_help() {
    ...
    std::cout << "  --test=NAME          Test name (throughput, latency, stress, compare, all," << std::endl;
    std::cout << "                         throughput_suite, latency_suite, stress_suite)" << std::endl;
    ...
    std::cout << "  ./performance_test --test=all --csv=full_results.csv" << std::endl;
}
